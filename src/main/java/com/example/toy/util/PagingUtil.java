...
public class PagingUtil {
    ...
    public String pageIndexList(String listUrl) {
        ...
        // listUrl의 값: /list?searchKey=people&searchValue=네번째
        if(listUrl.indexOf("?") != -1) { //쿼리스트링이 있을때(검색어가 있을때)
            listUrl += "&";
            // 검색어가 있을때: /list?searchKey=people&searchValue=네번째&
        ...
        // 검색어가 있을때: /list?searchKey=people&searchValue=네번째&pageNum=1
